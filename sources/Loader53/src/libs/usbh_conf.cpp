...
/**
  ...
  * @param  pipe: Pipe index This parameter can be a value from 1 to 15
  * @param  direction: Channel number  This parameter can be one of these values:   0: Output   1: Input
  * @param  ep_type: Endpoint Type This parameter can be one of these values: @arg EP_TYPE_CTRL: Control type @arg EP_TYPE_ISOC: Isochronous type
  *            @arg EP_TYPE_BULK: Bulk type @arg EP_TYPE_INTR: Interrupt type
  * @param  token: Endpoint Type This parameter can be one of these values:  @arg 0: PID_SETUP  @arg 1: PID_DATA
  * @param  pbuff: pointer to URB data
  * @param  length: length of URB data
  * @param  do_ping: activate do ping protocol (for high speed only) This parameter can be one of these values:
...
/**
  ...
  * @param  pipe: Pipe index  This parameter can be a value from 1 to 15
  * @retval URB state This parameter can be one of these values:
  *            @arg URB_IDLE  @arg URB_DONE  @arg URB_NOTREADY  @arg URB_NYET  @arg URB_ERROR  @arg URB_STALL      
  */
...
/**
  ...
  * @param  state: VBUS state This parameter can be one of these values:  0: VBUS Active 1: VBUS Inactive
  * @retval USBH Status
  */
